...
import com.unifreelancer.masso.timerapplication.R
...
class NotificationUtil {
    ...
    companion object {
        ...
        private const val CHANNEL_NAME_TIMER = "Timer Application"
        ...
        fun showTimerRunnning(context: Context, wakeUpTime: Long){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            if (nBuilder != null) {
                nBuilder.setContentTitle("Timer is Runnnig")
        ...
        fun showTimerPaused(context: Context){
            ...
            resumeIntent.action = AppConstant.ACTION_START
            ...
            if (nBuilder != null) {
                nBuilder.setContentTitle("Timer is paused")
                    ...
                    .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                    .addAction(R.drawable.ic_play_arrow, "Start", resumePendingIntent)
